...
const createPost = async (req, res, next) => {
  try {
    const { title, content, category, authorId, readTime, tags, featured } =
      req.body;
...
const updatePost = async (req, res, next) => {
  try {
    ...
    const { title, content, category, readTime, tags, featured } = req.body;
...
const getRelatedPosts = async (req, res, next) => {
  try {
    ...
    const relatedPosts = await Post.find({
      ...
      .select(
        "title content image slug likes comments createdAt views readTime tags featured"
